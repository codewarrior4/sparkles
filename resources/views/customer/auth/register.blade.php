...
<head>
    ...
    <title>Sparkles - Customer Register </title>
                    ...
                    <form method="POST" action="{{route('customer.store')}}">
                        ...
                        <div class="login-form-body">
                            ...
                            <div class="form-gp">
                                ...
                                <input type="text" name="phone" id="exampleInputPhone1">
                                <i class="ti-mobile"></i>
                            </div>
                            <div class="form-gp">
                            ...
                            <div class="form-footer text-center mt-5">
                                <p class="text-muted">Aready have an account? <a href="/customer/login">Sign in</a></p>
                            </div>
                        </div>
                    </form>
                </div><!--login-form-->
