...
<head>
    ...
    <title>Sparkles - Customer Login </title>
                    ...
                    <form method="POST" action="{{route('customer.authenticate')}}">
                        ...
                        <div class="login-form-body">
                            ...
                            <div class="form-footer text-center mt-5">
                                <p class="text-muted">Don't have an account? <a href="/customer/register">Sign up</a></p>
                                {{-- forgot password --}}
                                <a href="/customer/password/reset">Forgot Password?</a>
                            </div>
                        </div>
                    </form>
                </div><!--login-form-->
