        ...
        <div class="col-xl-6 col-md-6 col-lg-12 stretched_card">
            <div class="card mb-mob-4">
                ...
                <div class="card-body card_icon_right">
                    <div class="row">
                        <div class="col">
                            <h6 class="card_title text-uppercase text-muted mb-0">Total Laundries</h6>
                            <span class="font-weight-bold display-1 mb-0">{{count($laundry)}}</span>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="single-table">
                        <div class="table-responsive datatable-primary">
                            <table id="dataTable2" class="text-center table-hover">
                                ...
                                @foreach($laundry as $count => $order)
                                    <tr>
